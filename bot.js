...
const bscMainnetUrl = process.env.RPC_ENDPOINT //https://bsc-dataseed1.defibit.io/ https://bsc-dataseed.binance.org/
const wss = process.env.WSS_ENDPOINT; //wss://bsc-ws-node.nariox.org:443
const privateKey = process.env.YOUR_PRIVATE_KEY //your memonic;
